...
\textcopyright{} 2022 American Chemical Society. See appendix~\ref{app:permissions}
}}
...
\textcopyright{} 2024 American Chemical Society. See appendix~\ref{app:permissions}
}}
\graphicspath{{CH3/figures/}}
\section{Author Contributions}
In this work I created geometries for target data, performed both \emph{ab inito} and 
classical calculations target data.
I set up and performed parameter searches, implemented the force-field parameters, and ran all classical molecular dynamics simulations.
...
\chapter{Publisher Permission Letters}
