...
Along with dehydration, specific 
...
\begin{table}[h!tb]
    ...
    \begin{tabularx}{\linewidth}{l|X|X|X|X|X}
        ...
        \na{\tiny\textsubscript{From Saunders \etal{} 2022~\cite{saunders:2022}}}      & 216  & 216   &   200mM   & 103mM & 0.7$\mu$s\\\hline
...
\begin{table}[h!tb]
    ...
    \subcaption*{(a) Quantum mechanical reference energies}
    \begin{tabularx}{0.5\textwidth}{X|X|X|X}
        \hline
        Waters & CCSD(T) / CBS~\cite{wineman:2020:transferable} & PBE0 + vdW~\cite{wineman:2020:transferable} & AMOEBA-HFC~\cite{wineman:2020:transferable} \\
        \hline
             1  &  -344.8  &  -349.9  &  -349.8  \\
             2  &  -651.0  &  -657.6  &  -657.3  \\
             3  &  -898.7  &  -904.6  &  -902.5  \\
             4  & -1101.2  & -1103.4  & -1100.4  \\
        MAE &     -        &  4.9       &  4.0   \\
        \hline
    \end{tabularx}
    \subcaption*{(b) Classical force-field predictions}
    \begin{tabularx}{0.5\textwidth}{X|X|X|X}
        \hline
        Waters & Li et al.~\cite{merzparams} & Grotz et al.~\cite{microparams}  & Allner \etal{} \cite{villaparams}\\
        \hline
             1  &    -276.8  & -282.8   &-270.3\\
             2  &    -544.3  & -557.3   &-531.5\\
             3  &    -792.1. & -815.2   &-774.3\\
             4  &   -1018.3 & -1055.3   &-995.7\\
        MAE &            91.1     &  71.3& 106.0     \\
        \hline
    \end{tabularx}
...
\begin{table}[h!tb]
    \centering
    \small
    \caption[Lennard-Jones cross-terms for \mg{}]{Lennard-Jones cross-terms
    used in each \mg{} simulation. LB-terms are computed using
    Lorentz--Berthelot (LB) mixing rules, starting with the self-terms for
    \li{} from Joung and Cheatham III\etal{}\cite{joung:2008} and the
    self-terms for \mg{} from Li\etal{}\cite{merzparams}. The \mbnbfix{}
    parameters are chosen following the procedure described in the Methods
    section. The \mbnbfixmicro{} parameters for \mg{} only change the OW--\mg{}
    cross-term, using LB-rules to mix the self-terms from
    Grotz\etal{}\cite{microparams} with those of SPC/E water, without changing
    any other cross-terms. Energies \eps{} are in kJ/mol and \sig{} values are
    in nm.}
    
    %------------------------------------------
    % (a) Li+ cross-terms
    %------------------------------------------
    \subcaption*{(a) Lennard--Jones cross-terms for \li{}}
    \begin{tabularx}{0.9\textwidth}{l|X|X|X|X}
        \hline
        \multirow{2}{*}{Atom type} &
            \multicolumn{2}{c|}{LB-rules} &
            \multicolumn{2}{c}{\mbnbfix} \\\cline{2-5}
    ...
    % (b) Mg2+ cross-terms
    %------------------------------------------
    \subcaption*{(b) Lennard--Jones cross-terms for \mg{}}
    \begin{tabularx}{0.9\textwidth}{l|X|X|X|X|X|X}
        \hline
        \multirow{2}{*}{Atom type} &
            \multicolumn{2}{c|}{LB-rules} &
            \multicolumn{2}{c|}{\mbnbfix} &
            \multicolumn{2}{c}{\mbnbfixmicro} \\\cline{2-7}
        & \eps{} & \sig{} & \eps{} & \sig{} & \eps{} & \sig{} \\\hline
        CH3 & 0.19239 & 0.30856 & 0.68709 & 0.14257 & 0.68709 & 0.14257 \\\hline
        CH2 & 0.13238 & 0.32468 & 0.63126 & 0.20617 & 0.63126 & 0.20617 \\\hline
        OA  & 0.19044 & 0.26890 & 5.05190 & 0.26223 & 5.05190 & 0.26223 \\\hline
        P   & 0.32318 & 0.29044 & 3.89200 & 0.27811 & 3.89200 & 0.27811 \\\hline
        OM* & 0.20771 & 0.26469 & 3.22262 & 0.17691 & 3.22262 & 0.17691 \\\hline
        CO* & 0.06152 & 0.34796 & 0.56152 & 0.37127 & 0.56152 & 0.37127 \\\hline
        O*  & 0.20771 & 0.26469 & 2.43058 & 0.13069 & 2.43058 & 0.13069 \\\hline
        OW  & 0.16659 & 0.27944 & 0.16659 & 0.27944 & 13.75000 & 0.21010 \\\hline
    \end{tabularx}
...
%     starting with the self-terms for \li{} from Joung and Cheatham III\etal{}~\cite{joung:2008} and the self terms from \mg{} from the work of
%     Li \etal{}\cite{merzparams}. The \mbnbfix{} parameters are chosen following the procedure described in the methods section.
...
These data raise the question, what determines the mode of adsorption for a given ion? 
...
scattering,
or various NMR methods {(figures~\ref{figch3:eledens}, \ref{figch3:op}, and \ref{figch3:h2order} respectively).}
While the effect on lipid bilayer structure is not obvious in
the electron density {(figure~\ref{figch3:eledens})}, the perturbation can be seen in the \db~and water density --
the less hydrated ions induce slight thickening of the lipid bilayer. This
is reinforced by the chain ordering, where these ions increase chain ordering {(figure~\ref{figch3:op})} 
...
{larger} 
for the less hydrated ions \na{} and \li{} when compared to the more hydrated Mg\textsuperscript{2+} {(figure~\ref{figch3:h2order})}. 
