...
geometries for these clusters are reported in figure~\ref{figch4:optres} and table~\ref{tabch4:subenergies}.
...
\begin{figure}[h!bt]
    ...
    \label{figch4:optres}
    \includegraphics[width=0.8\textwidth]{Figure_S1.eps}
\end{figure}
\end{swaplandscape}
\begin{swaplandscape}
...
\hline
System & 1MeOAc & 2MeOAc & 3MeOAc & 4MeOAc & 1DEPh & 2DEPh 
       & {5W 1MeOAc} & {4W 2MeOAc} & {3W 3MeOAc} & {2W 4MeOAc} \\
\hline
PBE0 + VdW (Ref.) 
& -268.702 & -449.770 & -550.360 & -609.631 
& -942.545 & -1302.053
& -71.288 & -127.201 & -166.160 & -192.534 \\
\hline
LB Energy 
& -130.319 & -243.856 & -263.968 & -341.534
& -972.812 & -1051.842
& -91.759 & -177.528 & -253.576 & -317.715 \\
 Abs.\% 
& 0.515 & 0.458 & 0.520 & 0.440
& 0.032 & 0.192
& 0.287 & 0.396 & 0.526 & 0.650 \\
 MAPE 
& {} & {} & {} & 0.483
& {} & 0.112
& {} & {} & {} & 0.465 \\
\hline
2024 Energy 
& -299.844 & -545.386 & -598.606 & -690.483
& -1063.300 & -1488.761
& -165.829 & -316.012 & -402.648 & -507.049 \\
 Abs.\% 
& 0.116 & 0.213 & 0.088 & 0.133
& 0.128 & 0.143
& 1.326 & 1.484 & 1.423 & 1.634 \\
 MAPE 
& {} & {} & {} & 0.137
& {} & 0.136
& {} & {} & {} & 1.467 \\
\hline
2025 Energy 
& -32.724 & -59.544 & -42.191 & -98.578
& -772.729 & -1248.054
& -71.280 & -122.881 & -167.835 & -192.275 \\
 Abs.\% 
& 0.878 & 0.868 & 0.923 & 0.838
& 0.180 & 0.041
& 0.000 & 0.034 & 0.010 & 0.001 \\
 MAPE 
& {} & {} & {} & 0.877
& {} & 0.111
& {} & {} & {} & 0.011 \\
...
\caption[Substitution energies]{Energies (kJ/mol) associated with substituting
$n$ water molecules in low coordination clusters, and in 6-fold Mg-water
clusters with $n$ methyl acetates (MeAcs) or $n$ diethyl phosphates (DEPhs).
...
% \centering
% \sisetup{round-mode=places,round-precision=2,detect-all}
% \begin{tabularx}{\textwidth}{Y|Y|YYY|YYY|YYY}
% \hline  
% & {PBE0 + VdW} 
...
% \hline
% \end{tabularx}
%   \caption[Substitution energies]{Energies (kJ/mol) associated with substituting $n$ water molecules in low coordination clusters, and in 6-fold Mg-water clusters with $n$ methyl acetates (MeAcs) or $n$ diethyl phosphates (DEPhs). 
%   Substitution energies are defined in equation \ref{equ_2}.}
%   \label{tabch4:subenergies}
% \end{small}
% \end{table}
...
% \end{table}
We also compare the difference in substitution energies between the three parameter sets in table~\ref{tab:subs-relative-to-lb}.
We note that the 2024 \mg{} parameters tend to increase the binding strength of the interaction with the ligand over the LB rules parameters,
and the 2025 \mg{} parameters reduce the energy of binding to MeAc while increasing the interaction with DePh.
\begin{table}[h!bt]
\centering
\sisetup{round-mode=places,round-precision=3,detect-all}
...
\hline     
\end{tabularx}
\caption[Shifts in substitution energies relative to LB Rules]{Shifts in substitution energies relative to LB Rules:
...
Acyl-chain order parameters are computed using the method outlined by Douliez \etal~\cite{douliez:1995} (see  figure~\ref{figch4:acylorder}) and described at length in chapter 1 of this dissertation. It is noted 
...
\begin{figure}[h!bt]
    ...
    that the non-steric charges are most responsible for the perturbation of the bilayer thickness from that of the no-salt simulation shown as the blue region on the plot.}
    \label{figch4:chargeperlipid}
    \includegraphics[height=0.35\textheight]{Figure_6.eps}
\end{figure}
\section{Conclusions}
