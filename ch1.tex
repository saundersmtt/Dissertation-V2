...
The primary constituent molecules of lipid bilayers are phospholipids --- these are amphipathic molecules, with a hydrophilic headgroup and hydrophobic acyl chains linked 
by a glycerol backbone. These molecules self assemble into structures like bilayers in order to minimize the exposure of the acyl chains to water and maximize the headgroup exposure.
There are different kinds of phospholipid, defined by both the headgroup moiety and the length and saturation of the acyl-chains. Through the combination of headgroup and acyl-chains these
molecules contribute substantially and actively to the structure of the cell membrane.
...
This gradient is also the basis for the functioning of nerve cells, which use the flow of ions through membrane channels to propagate signals
along the cell body~\cite{alberts:2022:molecular}. 

This raises the question --- if there are ions around these bilayers, do they interact?
...
If one takes the solvent to be a dielectric continuum, the dissolved ions diffuse similarly to an uncorrelated gas --- however, when a boundary is introduced, like a lipid bilayer in this case, 
ions will accumulate at that surface~\cite{israelachvili:2011:intermol}.
This accumulation and binding occurs even when the surface is neutrally charged, due to the mutual repulsion of the ions acting to drive them onto the surface.
...
One can also use the electron density to directly obtain the peak-to-peak distance of the bilayer 
\dhh{} as one measure
of the bilayer thickness, illustrated in figure~\ref{figch1:thicknesses} (b). 
...
These measures are also visualized in figure~\ref{figch1:thicknesses} (a).
\begin{figure}[h!tb]
